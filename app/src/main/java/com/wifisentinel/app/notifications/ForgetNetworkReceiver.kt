...
class ForgetNetworkReceiver : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        if (intent.action != ACTION_FORGET && intent.action != ACTION_OPEN_WIFI_SETTINGS) return
    ...
    companion object {
        ...
        const val ACTION_OPEN_WIFI_SETTINGS = "com.wifisentinel.action.OPEN_WIFI_SETTINGS"
