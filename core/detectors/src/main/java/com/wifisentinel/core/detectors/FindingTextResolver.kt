...
object FindingTextResolver {
    ...
    fun resolve(context: Context, key: String): String {
        val resId = when (key) {
            ...
            FindingTextKeys.MAC_SPOOF_LOCAL_TITLE -> R.string.finding_mac_spoof_local_title
            FindingTextKeys.MAC_SPOOF_LOCAL_BODY -> R.string.finding_mac_spoof_local_body
            FindingTextKeys.MAC_SPOOF_OUI_TITLE -> R.string.finding_mac_spoof_oui_title
            FindingTextKeys.MAC_SPOOF_OUI_BODY -> R.string.finding_mac_spoof_oui_body
            FindingTextKeys.MAC_SPOOF_INVALID_TITLE -> R.string.finding_mac_spoof_invalid_title
            FindingTextKeys.MAC_SPOOF_INVALID_BODY -> R.string.finding_mac_spoof_invalid_body
            FindingTextKeys.EVIL_TWIN_BSSID_FLOOD_TITLE -> R.string.finding_evil_twin_bssid_flood_title
            FindingTextKeys.EVIL_TWIN_BSSID_FLOOD_BODY -> R.string.finding_evil_twin_bssid_flood_body
            FindingTextKeys.EVIL_TWIN_SIGNAL_TRAP_TITLE -> R.string.finding_evil_twin_signal_trap_title
            FindingTextKeys.EVIL_TWIN_SIGNAL_TRAP_BODY -> R.string.finding_evil_twin_signal_trap_body
            FindingTextKeys.EVIL_TWIN_DOWNGRADE_NEARBY_TITLE -> R.string.finding_evil_twin_downgrade_nearby_title
            FindingTextKeys.EVIL_TWIN_DOWNGRADE_NEARBY_BODY -> R.string.finding_evil_twin_downgrade_nearby_body
            FindingTextKeys.LOOKALIKE_INVISIBLE_TITLE -> R.string.finding_lookalike_invisible_title
            FindingTextKeys.LOOKALIKE_INVISIBLE_BODY -> R.string.finding_lookalike_invisible_body
            FindingTextKeys.LOOKALIKE_NUMERIC_TITLE -> R.string.finding_lookalike_numeric_title
            FindingTextKeys.LOOKALIKE_NUMERIC_BODY -> R.string.finding_lookalike_numeric_body
            FindingTextKeys.MAC_SPOOF_OUI_CHURN_TITLE -> R.string.finding_mac_spoof_oui_churn_title
            FindingTextKeys.MAC_SPOOF_OUI_CHURN_BODY -> R.string.finding_mac_spoof_oui_churn_body
            FindingTextKeys.CAPTIVE_PORTAL_PHISHING_TITLE -> R.string.finding_captive_portal_phishing_title
            FindingTextKeys.CAPTIVE_PORTAL_PHISHING_BODY -> R.string.finding_captive_portal_phishing_body
            FindingTextKeys.DNS_INTERCEPT_TITLE -> R.string.finding_dns_intercept_title
            FindingTextKeys.DNS_INTERCEPT_BODY -> R.string.finding_dns_intercept_body
            else -> 0
        }
